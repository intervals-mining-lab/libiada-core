namespace LibiadaMusic.Tests.BorodaDivider
{
    ...
    public class FmotivChainTests
    {
        ...
        public void FmotivChainTest()
        {
            ...
            chain.FmotivList[0].NoteList.Add(new ValueNote(new Pitch(0, 'A', 0), new Duration(1, 4, false, 480), false, Tie.None));
            chain.FmotivList[0].NoteList.Add(new ValueNote(new Pitch(0, 'B', 0), new Duration(1, 2, false, 480), false, Tie.None));

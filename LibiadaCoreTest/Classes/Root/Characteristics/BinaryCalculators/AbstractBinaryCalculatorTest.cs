namespace LibiadaCoreTest.Classes.Root.Characteristics.BinaryCalculators
{
    ...
    public abstract class AbstractBinaryCalculatorTest
    {
        ...
        {
            double result1 = this.Calculator.Calculate(Chains[index], this.elements["a"], this.elements["b"], Link.End);
            double result2 = this.Calculator.Calculate(Chains[index], this.elements["b"], this.elements["a"], Link.End);

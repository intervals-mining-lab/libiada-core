...
public static class FullCalculatorsFactory
{
    ...
    public static IFullCalculator CreateCalculator(FullCharacteristic type)
    {
        return type switch
        {
            ...
            FullCharacteristic.IdentifyingInformationVariance => new IdentifyingInformationVariance(),
            FullCharacteristic.IdentifyingInformationKurtosis => new IdentifyingInformationKurtosis(),
            FullCharacteristic.IdentifyingInformationKurtosisCoefficient => new IdentifyingInformationKurtosisCoefficient(),
            FullCharacteristic.IdentifyingInformationSkewness => new IdentifyingInformationSkewness(),
            FullCharacteristic.IdentifyingInformationSkewnessCoefficient => new IdentifyingInformationSkewnessCoefficient(),
            FullCharacteristic.IdentifyingInformationStandardDeviation => new IdentifyingInformationStandardDeviation(),
            ...
            FullCharacteristic.IdentifyingInformation => new IdentifyingInformation(),

...
namespace LibiadaMusicTest.BorodaDivider
{
    ...
    public class FmotivTest
    {
        ...
        public void TestFmotiv1()
        {
            ...
            var notelist = new List<Note> {(Note) note.Clone(), (Note) anote.Clone(), (Note) note.Clone()};
        ...
        public void TestFmotivTieGathered2()
        {
            ...
            fmotiv.NoteList.Add(new Note(new Pitch(1, 'A', 0), new Duration(1, 8, 2, 3, false, 320), false,
                Tie.StartStop, 4));
            fmotiv.NoteList.Add(new Note(new Pitch(1, 'A', 0), new Duration(1, 8, 2, 3, false, 320), false,
                Tie.StartStop, 3));
            fmotiv.NoteList.Add(new Note(new Pitch(1, 'A', 0), new Duration(1, 8, false, 480), false, Tie.Stop, 1));
        ...
        public void TestFmotivEquals3()
        {
            ...
            fmotiv.NoteList.Add(new Note(new Pitch(2, 'A', 0), new Duration(1, 8, 2, 3, false, 320), false,
                Tie.StartStop, 4));
            fmotiv.NoteList.Add(new Note(new Pitch(2, 'A', 0), new Duration(1, 8, 2, 3, false, 320), false,
                Tie.StartStop, 3));
            ...
            var fmotiv1 = new Fmotiv("ПМТ", 0);
            fmotiv1.NoteList.Add(new Note(new Pitch(3, 'A', 0), new Duration(1, 8, 2, 3, false, 320), false, Tie.Start,
                0));
            fmotiv1.NoteList.Add(new Note(new Pitch(3, 'A', 0), new Duration(1, 8, 2, 3, false, 320), false,
                Tie.StartStop, 1));
            fmotiv1.NoteList.Add(new Note(new Pitch(3, 'A', 0), new Duration(1, 8, 2, 3, false, 320), false,
                Tie.StartStop, 3));

...
namespace LibiadaMusicTest.ScoreModel
{
    ...
    public class TestUniformScoreTrack
    {
        ...
        public void TestNoteOrder1() 
        {
            ...
            {
                new Note(new Pitch(3, 'B', 0), new Duration(1, 16, false, 128), false, Tie.None, 1),
                new Note(new Pitch(3, 'A', 2), new Duration(1, 16, false, 128), false, Tie.None, 3),
                new Note(new Pitch(3, 'E', 0), new Duration(1, 4, false, 512), false, Tie.None, 0),
                new Note(new Pitch(3, 'E', 0), new Duration(1, 4, false, 512), false, Tie.None, 0),
                new Note(new Pitch(3, 'C', 1), new Duration(1, 16, false, 128), false, Tie.None, 1),
                new Note(new Pitch(3, 'A', -1), new Duration(1, 16, false, 128), false, Tie.None, 3),
                new Note(new Pitch(3, 'D', 0), new Duration(1, 4, false, 128), false, Tie.None, 2),
                new Note(new Pitch(3, 'A', 2), new Duration(1, 16, false, 128), false, Tie.None, 3),
                new Note(new Pitch(3, 'C', 1), new Duration(1, 4, false, 128), false, Tie.None, 1),
                new Note((Pitch) null, new Duration(1, 4, false, 128), false, Tie.None, 1),
                new Note((Pitch) null, new Duration(1, 4, false, 128), false, Tie.None, 1),
                new Note((Pitch) null, new Duration(1, 16, false, 128), false, Tie.None, 1),
                new Note((Pitch) null, new Duration(1, 16, false, 128), false, Tie.None, 1)
            };
        ...
        public void TestMeasureOrder1()
        {
            ...
            {
                new Note(new Pitch(3, 'B', 0), new Duration(1, 16, false, 128), false, Tie.None, 3),
                new Note(new Pitch(3, 'E', 0), new Duration(1, 4, false, 512), false, Tie.None, 0),
                new Note(new Pitch(3, 'E', 0), new Duration(1, 4, false, 512), false, Tie.None, 0),
                new Note(new Pitch(3, 'C', 1), new Duration(1, 16, false, 128), false, Tie.None, 1)
            };
            ...
            var notes5 = new List<Note>
            {
                new Note((Pitch) null, new Duration(1, 4, false, 128), false, Tie.None, 1),
                new Note((Pitch) null, new Duration(1, 4, false, 128), false, Tie.None, 1)
            };

            var notes6 = new List<Note>
            {
                new Note((Pitch) null, new Duration(1, 16, false, 128), false, Tie.None, 1),
                new Note((Pitch) null, new Duration(1, 16, false, 128), false, Tie.None, 1)
            };

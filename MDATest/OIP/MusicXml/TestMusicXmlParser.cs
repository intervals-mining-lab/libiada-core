...
namespace MDATest.OIPTest.MusicXml
{
    ...
    public class TestMusicXmlParser
    {
        ...
        public void TestXmlParser()
        {
            ...
            notes1.Add(new ValueNote(new Pitch(3, 'E', 0), new Duration(1, 2, false, 2048), false, Tie.None));
            notes1.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 8, false, 512), false, Tie.None));
            notes1.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 8, false, 512), false, Tie.None));
            notes1.Add(new ValueNote(new Pitch(3, 'F', 0), new Duration(1, 8, false, 512), false, Tie.Start));
            List<ValueNote> notes2 = new List<ValueNote>();
            notes2.Add(new ValueNote(new Pitch(3, 'F', 0), new Duration(1, 8, false, 512), false, Tie.Stop));
            notes2.Add(new ValueNote(new Pitch(3, 'B', 0), new Duration(1, 8, false, 512), false, Tie.None));
            notes2.Add(new ValueNote(new Pitch(3, 'G', 0), new Duration(1, 8, false, 512), false, Tie.None));
            notes2.Add(new ValueNote(new Pitch(4, 'C', 0), new Duration(1, 8, false, 512), false, Tie.None));
            notes2.Add(new ValueNote(new Pitch(3, 'G', 0), new Duration(1, 8, false, 512), false, Tie.None));
            notes2.Add(new ValueNote(new Pitch(3, 'E', 0), new Duration(1, 8, false, 512), false, Tie.None));
            notes2.Add(new ValueNote(new Pitch(2, 'A', 0), new Duration(1, 8, false, 512), false, Tie.None));
            List<ValueNote> notes3 = new List<ValueNote>();
            notes3.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes3.Add(new ValueNote(new Pitch(3, 'G', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes3.Add(new ValueNote(new Pitch(4, 'E', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes3.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes3.Add(new ValueNote(new Pitch(3, 'B', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes3.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes3.Add(new ValueNote(new Pitch(4, 'D', 0), new Duration(1, 8, true, 768), false, Tie.None));
            notes3.Add(new ValueNote(new Pitch(4, 'C', 0), new Duration(1, 8, true, 768), false, Tie.None));
            notes3.Add(new ValueNote(null, new Duration(1, 8, false, 512), false, Tie.None));
            // паузы, поэтому null вместо Pitch
            List<ValueNote> notes4 = new List<ValueNote>();
            notes4.Add(new ValueNote(new Pitch(4, 'C', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(3, 'E', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(4, 'C', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(3, 'E', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(2, 'A', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(4, 'D', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(4, 'C', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(2, 'E', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(4, 'C', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(3, 'G', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(3, 'A', 0), new Duration(1, 16, false, 256), false, Tie.None));
            notes4.Add(new ValueNote(new Pitch(4, 'C', 0), new Duration(1, 16, false, 256), false, Tie.None));

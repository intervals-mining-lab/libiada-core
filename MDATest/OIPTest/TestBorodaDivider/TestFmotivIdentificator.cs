...
//        FmotivChain fmidentedchain = new FmotivChain();
        Assert.AreEqual(0, fmid.GetIdentification(fmchain1).FmotivList[0].Id);
        Assert.AreEqual(1, fmid.GetIdentification(fmchain1).FmotivList[1].Id);
        Assert.AreEqual(1, fmid.GetIdentification(fmchain1).FmotivList[2].Id);
        Assert.AreEqual(1, fmid.GetIdentification(fmchain1).FmotivList[3].Id);
        Assert.AreEqual(0, fmid.GetIdentification(fmchain1).FmotivList[4].Id);
        Assert.AreEqual(0, fmid.GetIdentification(fmchain1).FmotivList[5].Id);
    ...
    public void TestFmotivIdentification2()
    {
        ...
        //        FmotivChain fmidentedchain = new FmotivChain();
        Assert.AreEqual(0, fmid.GetIdentification(fmchain1).FmotivList[0].Id);
        Assert.AreEqual(0, fmid.GetIdentification(fmchain1).FmotivList[1].Id);
        Assert.AreEqual(0, fmid.GetIdentification(fmchain1).FmotivList[2].Id);
        Assert.AreEqual(1, fmid.GetIdentification(fmchain1).FmotivList[3].Id);
        Assert.AreEqual(2, fmid.GetIdentification(fmchain1).FmotivList[4].Id);
        Assert.AreEqual(3, fmid.GetIdentification(fmchain1).FmotivList[5].Id);
